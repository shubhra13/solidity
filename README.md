...
- Motivation for this contract is to split profits among employees based on their title. Since we are using Solidity contracts, profit sharing will be transparent, and accounting/auditing automatic and seemless.


## Details

In this project we have 3 different contracts:
...
### A) Either you can compile and deploy on any testnet you want.

`OR`

### B) Use a pre-deployed contracts on Kovan Testnet:

- Compile `AssociateProfitSplitter.sol`
- To deploy use `At Address` and put the below contract address
contract address for AssociateProfitSplitter:
- At Address: `0x4c0e61adfabee055e87c3795d61d0b2b1a2beb0e`
- click on `At Address:`
---
- Compile `TieredProfitSplitter.sol`
- To deploy use `At Address` and put the below contract address
contract address for TieredProfitSplitter:
- At Address: `0x3ecfa98986155263ebcf7c3c81acaa69923a6223`
- click on `At Address:`
---
- Compile `DeferredEquityPlan.sol`
- To deploy use `At Address` and put the below contract address
contract address for DeferredEquityPlan:
- At Address: `0xcf98d6d0acbaabf3c999ed63d46b2bbb5899fd26`
- click on `At Address:`


## How the contract transactions look like
...
https://kovan.etherscan.io/tx/0x7956632bfc363a9b01c170dd271f5a7b69a730f7162ce7d5a274892194913a54

![`AssociateProfitSplitter`](Images/AssociateProfitSplitter.png)

---
### TieredProfilSplitter
---
#### Transaction Details:

https://kovan.etherscan.io/tx/0xaa0cfdb596f1fce5034a2d97bc8791fcd522ff4cc6684dbefcebe5d519434a48
...
`NOTE:` This will fail unless its past 365 days from deployment(Aug 12, 2020)

https://kovan.etherscan.io/tx/0x084d89a9ff4a2a39a6bc5733e250d2b0c482a5c47e432e585f36e7726b84fbe0
...
This project has 3 levels of difficulty, with each contract increasing in complexity and capability. Start with Level 1, then move forward as you complete the challenges. You can build all three with the skills you already have!
